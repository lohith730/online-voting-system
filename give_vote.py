...
if os.path.exists('data/names.pkl') and os.path.exists('data/faces_data.pkl'):
    with open('data/names.pkl', 'rb') as f:
        try:
            ...
            print("Error: names.pkl is empty or corrupted.")
            LABELS = []  # Handle the error as needed

    with open('data/faces_data.pkl', 'rb') as f:
        try:
            FACES = pickle.load(f)
        except EOFError:
            print("Error: faces_data.pkl is empty or corrupted.")
            FACES = []  # Handle the error as needed
else:
    print("Error: One or both of the required files do not exist.")
    exit()
